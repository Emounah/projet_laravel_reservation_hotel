                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-blue f-w-600"> Réservation <br> en cours</span>
                                    <h4>49/50GB</h4>
                                    <div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-pink f-w-600">Réservation <br> pas en cours</span>
                                    <h4>$23,589</h4>
                                    <div>
                                        <!-- <span class="f-left m-t-10 text-muted">
                                            <i
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-green f-w-600">Chambre Libre</span>
                                    <h4>45</h4>
                                    <div>
                                        <!-- <span class="f-left m-t-10 text-muted">
                                            <i
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-yellow f-w-600">Total <br> Employeur</span>
                                    <h4>+562</h4>
                                    <div>
                                        <!-- <span class="f-left m-t-10 text-muted">
                                            <i
